  ...
  return (
    <section className="relative overflow-hidden px-5 py-16 text-center sm:py-24">
      ...
      <div className="relative mx-auto max-w-2xl">
        {/* Glow orb effect */}
        <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-base-blueLight/20 blur-3xl opacity-0 animate-[fadeInGlow_3s_ease-out_0.5s_forwards]" />
        ...
        <div className="relative space-y-6 opacity-0 animate-[fadeInUp_1s_ease-out_0.3s_forwards]">
          ...
          <p className="mx-auto max-w-xl text-[17px] leading-relaxed text-white/60">
            AI agents can call APIs, process information, interact with
            wallets, and execute transactions. BaseZap provides payment-aware
            infrastructure for agent workflows, including{" "}
            <span className="font-semibold text-white">x402</span> pay-per-action
            services.
          </p>
          ...
          <div className="relative mx-auto max-w-lg rounded-xl border border-base-blueLight/30 bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-6 backdrop-blur-sm transition-all duration-500 hover:border-base-blueLight/50 hover:bg-gradient-to-br hover:from-white/[0.05] hover:to-white/[0.02]">
            <div
              className="absolute -inset-1 rounded-xl bg-gradient-to-r from-base-blueLight/20 to-blue-500/20 opacity-0 blur transition-opacity duration-500 group-hover:opacity-100"
            ...
            <div className="relative space-y-3">
              ...
              <div className="space-y-2 text-sm text-white/70">
                <p>
                  <span className="text-white">Agent</span> needs a BaseZap
                  service.
                </p>
                ...
                <p>
                  <span className="text-white">Caller pays</span> $0.001 USDC
                  via x402 for the paid service.
                </p>
                <p className="flex items-center justify-center gap-2 text-white/50">
                  <span>↓</span>
                </p>
                <p>
                  <span className="text-white">BaseZap returns</span> the
                  requested result or unsigned transaction data.
                </p>
                <p className="flex items-center justify-center gap-2 text-white/50">
                  <span>↓</span>
                </p>
                <p>
                  <span className="text-white">Tip transactions</span> use the
                  standard 2% platform fee model.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-4">
            ...
            <p className="text-xs text-white/50">
              ...
              <a
                href="/docs/x402"
                className="font-semibold text-base-blueLight/80 transition-colors hover:text-base-blueLight"
              >
